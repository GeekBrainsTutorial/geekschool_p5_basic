...
function draw() {
	...
	if(mouseX<95 && mouseY<200) {
		robot(95, 200, allColor, strokeColor)
	}
	else if(mouseX>width-95 && mouseY<200){
		robot(width-95, 200, allColor, strokeColor)
	}
	else if(mouseX>width-95 && mouseY>height-140){
		robot(width-95, height-140, allColor, strokeColor)
	}
	else if(mouseX<95 && mouseY>height-140){
		robot(95, height-140, allColor, strokeColor)
	}
	else if(mouseX<95){
		robot(95, mouseY, allColor, strokeColor)
	}
	else if(mouseY<200) {
		robot(mouseX, 200, allColor, strokeColor)
	}
	else if(mouseX>width-95) {
		robot(width-95, mouseY, allColor, strokeColor)
	}
	else if(mouseY>height-140) {
		robot(mouseX, height-140, allColor, strokeColor)
	}
	else {
		robot(mouseX, mouseY, allColor, strokeColor)
	}
}


function robot(centerX, centerY, allColor, strokeColor) {
	fill(allColor)
	stroke(strokeColor)
